                ...
                <div class="column is-4 is-offset-4">
                    ...
                    <div class="box">
                        <form action="control/gerencia-cadastro.php" method="POST">
                            ...
                            <div class="field">
                                <div class="control">
                                    <input name="cpf" class="input is-large" type="text" placeholder="CPF" maxlength="12" required>
                                </div>
                            </div>
                            <div class="field">
                                <div class="control">
                            ...
                            <a id="btn-voltar" href="portal-professor.php" class="button is-block is-dark is-large is-fullwidth" style="margin-top:5px;">Voltar</a>
                        </form>
                    </div>
                </div>
            </div>
